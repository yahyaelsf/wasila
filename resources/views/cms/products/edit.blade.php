                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 " style="width: 100%;" id="category_id" name="category_id">
                            @foreach ($data as $category)
                                <option value="{{ $category->id }}" @if ($product->category->id == $category->id) selected="selected" @endif>{{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="customSwitch1"  @if ($product->active_name == 'فعال') checked @endif name="active">
                        ...
                        <div class="card-footer">
                            <button type="button" onclick="updateItem({{ $product->id }})"
...
<script>
    function updateItem(id) {
        ...
        store('/products/{{ $product->id }}', formData);
